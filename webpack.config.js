...
Encore
    ...
    .setPublicPath((process.env.DEPLOY_BASE || "") + "/build")
    ...
    .addStyleEntry("css/dialog", "./assets/scss/dialog.scss")
    ...
    // TODO: remove these two. Replace img with Entity and data with Controller.
    .copyFiles({
        from: "./assets/img",
